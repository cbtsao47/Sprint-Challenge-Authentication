...
1. What is the purpose of using _sessions_?
   -the purpose of using sessions is to persist data.
1. What does bcrypt do to help us store passwords in a secure manner.

- bcrypt help us randomize the password by hashing it so no real passwords are stored in the database.

1. What does bcrypt do to slow down attackers.

- it hashes the password with a key derivation function. It also adds a random string(salt) to increase password length.
